const businesses = [
  ...
  export const getBusinesses = () => {
    const copyOfBusinesses = businesses.map(item => ({...item}))
    return copyOfBusinesses
  }


const newYorkLocation = (businessObj) => {
  ...
  export const getNewYorkBusinesses = () => {
    let newYorkArray = businesses.filter(newYorkLocation)
    return newYorkArray
  }


 const manufacturing = (businessObj) => {
  ...
  export const getManufacturingBusinesses = () => {
    let manufacturingArray = businesses.filter(manufacturing)
    return manufacturingArray
  }


  export const getAgents = () => {
    const onlyAgents = businesses.map(businessObj => {
